/** @import { GraphNode } from '../../patram-types.ts' */
 ...
 *   endpoint: string,
 *   graph_api?: {
 *     load_project_graph: (repo_directory: string) => Promise<import('../../patram-types.ts').ProjectGraphResult>,
 *     query_graph: import('../../patram-types.ts').GraphApi['query_graph'],
 *   },
