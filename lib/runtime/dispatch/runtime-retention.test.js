...
import { createPravahaConfigSource } from '../../../test/fixtures/runtime-fixture.js';
          ...
          return Promise.resolve({
            ...
            diagnostics: [
              createPatramDiagnostic(
                'bad graph',
                'docs/contracts/runtime/reconciler.md',
              ),
            ],
          });
        },
...
/**
 * @param {import('patram').PatramGraphNode[]} nodes
 * @returns {patram.PatramQueryResult}
 */
function createQueryGraphResult(nodes) {
  return {
    diagnostics: [],
    nodes,
