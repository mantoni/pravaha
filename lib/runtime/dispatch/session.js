...
import { dispatchAssignmentAndWait } from './explicit-assignment.js';
import {
...
export { dispatchAssignmentAndWait } from './explicit-assignment.js';
...
async function dispatch(repo_directory, options = {}) {
  if (
    ...
    return dispatchAssignmentAndWait(repo_directory, assignment, {
      graph_api: options.graph_api,
      now: options.now,
      operator_io: options.operator_io,
