 ...
 *   format_version?: 'javascript-flow-v1' | 'state-machine-v2',
 ...
 * @returns {Omit<
 *   DurableAttemptContext,
 *   'current_job_name' | 'job_outputs' | 'job_visit_counts' | 'queue_wait'
 * > & {
 *   current_handler_name: string,
 *   flow_state: Record<string, unknown>,
 *   wait_state?: {
 ...
 * }}
 */
function createJavaScriptFlowResumeAttemptContext(
  repo_directory,
  runtime_record,
  runtime_record_path,
) {
