...
import { cleanupExpiredTerminalRuntimeRecords } from '../dispatch/runtime-retention.js';
import {
 ...
 * @param {{
 *   graph_api?: import('../../shared/types/patram-types.ts').OptionalGraphApi,
 *   now?: () => Date,
...
async function status(repo_directory, options = {}) {
  await cleanupExpiredTerminalRuntimeRecords(repo_directory, {
