...
function createFlowFixtures() {
  return {
    'docs/flows/runtime/codex-sdk-happy-path.yaml': createHappyPathFlowSource(),
  };
}
 ...
 * @returns {string}
 */
function createHappyPathFlowSource() {
  return [
    'kind: flow',
    'id: codex-sdk-happy-path',
    'status: active',
 ...
 * @returns {string[]}
 */
function createHappyPathJobLines() {
  return [
    'jobs:',
    '  prepare_workspace:',
    '    uses: core/run',
