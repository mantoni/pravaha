...
async function validateQueueCandidate(
  ...
  try {
    ...
    const run_result = await runStateMachineAttempt(repo_directory, {
      binding_targets: {
        document: {
      ...
      runtime_label: 'Queue validation flow',
    ...
    runtime_record_path = run_result.runtime_record_path;

    return run_result.outcome === 'success' ? 'success' : 'failure';
  } finally {
