/** @import { JsonReadResult, SemanticModel, ValidationDiagnostic } from '../../shared/types/validation.types.ts' */
...
function resolvePravahaMappings(
  ...
  const semantic_roles = pravaha_config.semantic_roles;
  const semantic_states = pravaha_config.semantic_states;
