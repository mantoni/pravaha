...
it('rejects missing or mismatched root flow metadata in the active contract', async () => {
  ...
  vi.doMock('node:fs/promises', async () => {
    ...
    return {
      ...actual_module,
      readFile: async () =>
        '---\nRoot flow: docs/flows/runtime/other-flow.md\n---\n',
    };
  });
  ...
  await expect(selectActiveContract('/repo')).rejects.toThrow(
    'Expected docs/contracts/runtime/codex-sdk-happy-path.md to bind docs/flows/runtime/codex-sdk-happy-path.md, found docs/flows/runtime/other-flow.md.',
  );
