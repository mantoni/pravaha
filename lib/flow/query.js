...
/**
 * @param {string} query_text
 * @param {Set<string> | undefined} semantic_role_names
 * @returns {string}
 */
function resolveSelectQueryRole(query_text, semantic_role_names) {
  ...
  if (
    semantic_role_names !== undefined &&
    !semantic_role_names.has(selected_role)
  ) {
    throw new Error(
 ...
 * @returns {string}
 */
function resolveDurableQueryRole(query_text) {
