 ...
 *   queue_handoff: (with_value: Record<string, unknown>) => Promise<Record<string, unknown>>,
 ...
 *   worktree_handoff: (with_value: Record<string, unknown>) => Promise<Record<string, unknown>>,
 * }} flow_runtime
 ...
 * @returns {Promise<Record<string, unknown>>}
 */
async function queueHandoff(ctx, with_value) {
  return readRequiredFlowRuntime(ctx).queue_handoff(with_value);
}
 ...
 * @returns {Promise<Record<string, unknown>>}
 */
async function worktreeHandoff(ctx, with_value) {
  return readRequiredFlowRuntime(ctx).worktree_handoff(with_value);
}
...
function readRequiredFlowRuntime(ctx) {
  ...
  if (
    ...
    typeof (/** @type {Record<string, unknown>} */ (flow_runtime).approve) !==
      'function' ||
    typeof (
      /** @type {Record<string, unknown>} */ (flow_runtime).queue_handoff
    ) !== 'function' ||
    typeof (
      /** @type {Record<string, unknown>} */ (flow_runtime).worktree_handoff
    ) !== 'function'
  ) {
